    ...
    <main>
        ...
        <div class="auth-container">
            <div class="auth-card">
                ...
                <form method="post" autocomplete="off" class="formuario">
                    <div class="form-group">
                        <label for="current_password">Localidad / Ubicacion actual:
                            <?php echo htmlspecialchars($_SESSION['user_location']); ?></label>
                    </div>
                    <div class="form-group">
