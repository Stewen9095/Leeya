...
<div style="max-width:1100px;margin:2vw auto 0 auto;">
    <form method="get" style="width:100%;margin-bottom:2vw;display:flex;gap:1vw;flex-wrap:wrap;justify-content:center;">
        <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Buscar libro por título, autor o género..." style="flex:2;padding:0.8vw 1vw;border-radius:1vw;border:none;font-size:1.1vw;">
        ...
        <button type="submit" style="background:#001aaf;color:#fff;border:none;padding:0.8vw 2vw;border-radius:1vw;font-size:1.1vw;cursor:pointer;">Buscar libro</button>
    </form>
    <form method="get" style="width:100%;margin-bottom:2vw;display:flex;gap:1vw;flex-wrap:wrap;justify-content:center;">
        <input type="text" name="search_user" value="<?= htmlspecialchars($search_user) ?>" placeholder="Buscar usuario por nombre..." style="flex:2;padding:0.8vw 1vw;border-radius:1vw;border:none;font-size:1.1vw;">
        <button type="submit" style="background:#001aaf;color:#fff;border:none;padding:0.8vw 2vw;border-radius:1vw;font-size:1.1vw;cursor:pointer;">Buscar usuario</button>
    </form>
</div>
        ...
        <?php foreach ($users as $user): ?>
            <div class="fullbook">
                ...
                <div class="infolibro">
                    ...
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Email:</b> <?= htmlspecialchars($user['email']) ?></p>
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Ubicación:</b> <?= htmlspecialchars($user['location']) ?></p>
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Descripción:</b> <?= htmlspecialchars($user['lildescription']) ?></p>
        ...
        <?php foreach ($books as $book): ?>
            <div class="fullbook">
                ...
                <div class="infolibro">
                    ...
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Autor:</b> <?= htmlspecialchars($book['author']) ?></p>
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Género:</b> <?= htmlspecialchars($book['genre']) ?></p>
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Editorial:</b> <?= htmlspecialchars($book['editorial']) ?></p>
                    <p style="font-size:0.95vw;color:#555;margin:0 0 0.5vw 0;"><b>Publicado por:</b> <?= htmlspecialchars($book['owner_name']) ?></p>
